...
const sortByFeed = (arr) => {
    const getProp = (obj) => obj.ratingRevievs.match(/\d+/gi)[0]; 
    
    return arr.sort((a, b) => parseInt(getProp(a)) > parseInt(getProp(b)) ? 1 : -1);
}

console.log(sortByFeed(arr));
